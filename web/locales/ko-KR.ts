...
export const koKR: Translations = {
    ...
    stream: {
        ...
        bitrateDecreased: (kbps: number) => `네트워크 혼잡, 비트레이트를 ${kbps} kbps로 낮춤`,
        bitrateIncreased: (kbps: number) => `네트워크 복구, 비트레이트를 ${kbps} kbps로 높임`,
        bitrateReverted: (kbps: number) => `네트워크 불안정, ${kbps} kbps로 되돌림`,
    ...
    settings: {
        ...
        video: "비디오",
        bitrate: "비트레이트 (Kbps)",
        adaptiveBitrate: "적응형 비트레이트 (WebSocket)",
        fps: "프레임 (FPS)",
        videoSize: "해상도 설정",
        native: "기본값",
        custom: "사용자 정의",
