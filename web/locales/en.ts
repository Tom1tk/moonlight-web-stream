export const en = {
    ...
    stream: {
        ...
        bitrateDecreased: (kbps: number) => `Connection congested, lowering bitrate to ${kbps} kbps`,
        bitrateIncreased: (kbps: number) => `Connection recovered, raising bitrate to ${kbps} kbps`,
        bitrateReverted: (kbps: number) => `Connection unstable, reverting to ${kbps} kbps`,
    ...
    settings: {
        ...
        adaptiveBitrate: "Adaptive Bitrate (WebSocket)",
        fps: "Fps",
