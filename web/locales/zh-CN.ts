...
export const zhCN: Translations = {
    ...
    stream: {
        ...
        bitrateDecreased: (kbps: number) => `网络拥塞，码率降至 ${kbps} kbps`,
        bitrateIncreased: (kbps: number) => `网络恢复，码率提升至 ${kbps} kbps`,
        bitrateReverted: (kbps: number) => `网络不稳定，恢复到 ${kbps} kbps`,
    ...
    settings: {
        ...
        video: "视频",
        bitrate: "码率 (Kbps)",
        adaptiveBitrate: "自适应码率 (WebSocket)",
        fps: "帧率",
        videoSize: "视频分辨率",
        native: "原生",
        custom: "自定义",
