...
export const ptBR: Translations = {
    ...
    stream: {
        ...
        bitrateDecreased: (kbps: number) => `Rede congestionada, taxa de bits reduzida para ${kbps} kbps`,
        bitrateIncreased: (kbps: number) => `Rede recuperada, taxa de bits aumentada para ${kbps} kbps`,
        bitrateReverted: (kbps: number) => `Rede instável, revertendo para ${kbps} kbps`,
    ...
    settings: {
        ...
        adaptiveBitrate: "Taxa de bits adaptativa (WebSocket)",
        fps: "FPS",
