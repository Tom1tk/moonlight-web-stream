...
export const frFr: Translations = {
    ...
    stream: {
        ...
        bitrateDecreased: (kbps: number) => `Réseau congestionné, débit réduit à ${kbps} kbps`,
        bitrateIncreased: (kbps: number) => `Réseau rétabli, débit augmenté à ${kbps} kbps`,
        bitrateReverted: (kbps: number) => `Réseau instable, retour à ${kbps} kbps`,
    ...
    settings: {
        ...
        video: "Vidéo",
        bitrate: "Débit (Kbps)",
        adaptiveBitrate: "Débit adaptatif (WebSocket)",
        fps: "Ips",
